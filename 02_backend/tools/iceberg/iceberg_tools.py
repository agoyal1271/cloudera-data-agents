...
MOCK_TABLES = [
    ...
    # ── Order Intelligence pipeline tables ────────────────────────────────────
    {
        "name": "demo.products",
        "location": "/Users/archit/iceberg-warehouse/demo/products",
        "description": "Product catalogue reference — joined into enriched_orders",
        "fields": [
        ...
        "partition_spec": "identity(category)",
        "snapshots": 4,
        "row_count": 12_400,
        "file_count": 3,
        "size_bytes": 890_000,
    ...
    },
    {
        ...
        "location": "/Users/archit/iceberg-warehouse/demo/raw_orders",
        "description": "Landing zone — raw order events from Kafka via NiFi (no transforms, append-only)",
        "fields": [
        ...
        "partition_spec": "days(ingested_at)",
        "snapshots": 312,
        "row_count": 9_840_000,
        "file_count": 248,
        "size_bytes": 4_120_000_000,
        "mock": True,
    },
    {
        "name": "demo.enriched_orders",
        "location": "/Users/archit/iceberg-warehouse/demo/enriched_orders",
        "description": "Orders joined with customer + product dimensions; discount tiers and revenue columns computed",
        "fields": [
            {"name": "order_id",           "type": "string"},
            {"name": "customer_id",        "type": "string"},
            {"name": "customer_name",      "type": "string"},
        ...
        "partition_spec": "days(order_date), identity(region)",
        "snapshots": 288,
        "row_count": 9_831_400,
        "file_count": 512,
        "size_bytes": 7_890_000_000,
        "mock": True,
    },
    {
        "name": "demo.order_analytics_mart",
        "location": "/Users/archit/iceberg-warehouse/demo/order_analytics_mart",
        "description": "Daily/regional aggregate mart with window-function metrics — source for Operations KPI dashboard",
        "fields": [
        ...
        "partition_spec": "days(report_date)",
        "snapshots": 96,
        "row_count": 18_240,
        "file_count": 32,
...
def list_iceberg_tables(force_refresh: bool = False) -> list[dict[str, Any]]:
    ...
    try:
        ...
        try:
            from tools.catalog import catalog_store
            catalog_store.index_iceberg_tables_bulk(MOCK_TABLES)
        except Exception:
            pass
        _LIST_CACHE["result"] = MOCK_TABLES
        _LIST_CACHE["expires_at"] = time.monotonic() + 60  # shorter TTL; retry live catalog sooner
        return MOCK_TABLES
